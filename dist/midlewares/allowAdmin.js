...
exports.allowAdmin = void 0;
const jsonwebtoken_1 = __importDefault(require("jsonwebtoken"));
const environment_1 = require("../environment");
const customError_1 = require("../types/customError");
const dao_1 = require("../dao");
const utils_1 = require("../utils/utils");
const allowAdmin = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (!token) {
            ...
            if (!decoded.isAdmin)
                throw new customError_1.CustomError("Acceso denegado, token inválido", 401);
            req.decoded = decoded;
            next();
        }
    }
        ...
        if (isJwtError) {
            ...
            status = 401;
            console.error(`ERROR: Token inválido o expirado - ${err.message} - (allowAdmin)`);
        }
        else if (err instanceof customError_1.CustomError) {
            message = "ERROR: " + err.message;
            status = err.status;
            console.error(`${message} - (allowAdmin)`);
        }
        else {
...
//# sourceMappingURL=allowAdmin.js.map