...
exports.verifyTokenOrTableName = void 0;
...
const verifyTokenOrTableName = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const tableName = req.query.tableName;
        if (tableName && data_1.tablesForReadWithOutToken.includes(tableName)) {
            next();
        }
        else {
...
exports.verifyTokenOrTableName = verifyTokenOrTableName;
//# sourceMappingURL=verifyTokenOrTableName.js.map